...
plt.show()
chart_data = pd.DataFrame(range(1, Ks), distortions)
...
plt.show()
chart_data = pd.DataFrame(K, cost)
st.line_chart(chart_data, width=300, height=300)
...
final_kmode.loc[final_kmode['cluster_predicted'] == 2]


# In[225]:


final_kmode.loc[final_kmode['cluster_predicted'] == 3]


# In[226]:


final_kmode.loc[final_kmode['cluster_predicted'] == 1]


# In[227]:


final_kmode.loc[final_kmode['cluster_predicted'] == 0]
