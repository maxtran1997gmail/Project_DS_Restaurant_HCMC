...
print(consideration[(consideration['AHP_Level'] == 'Medium') & (consideration['APD_Level'] == 'Very High')])
print('Quận có Chi Phí nhà tương đối, mật độ dân số rất cao là Quận 4')
...
print(consideration[(consideration['AHP_Level'] == 'Medium') & (consideration['APD_Level'] == 'High')])
print('Quận có Chi Phí nhà tương đối, mật độ dân số cao là Quận 8 ')
...
print(consideration[(consideration['AHP_Level'] == 'Low') & (consideration['APD_Level'] == 'Medium')])
print('Quận có chi phí nhà thấp , mật độ dân số tương đối là Quận 12 ')
